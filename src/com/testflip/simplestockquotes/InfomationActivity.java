...
/*    		Intent intentNews = new Intent(this, NewsActivity.class);
    		...
    		browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://finance.yahoo.com/q/h?s=Headlines+" + Ticker));
...
/*    		Intent intentChart = new Intent(this, ChartActivity.class);
    		...
    		browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://finance.yahoo.com/q/bc?s=Basic+Chart+" + Ticker));
    		startActivity(browserIntent);
