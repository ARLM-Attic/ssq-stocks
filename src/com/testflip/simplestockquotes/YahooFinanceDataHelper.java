...
public class YahooFinanceDataHelper {
    ...
    */
    private static final String SP500_LIST = "MSFT+YOKU+AVG+DELL+GOOG";
    ...
    public static List<Stock> parseResponse(String strCustomStocks) {
        ...
        stockList = new ArrayList<Stock>();
             ...
             try {
            	...
            	if (strCustomStocks == "") {
            		yahooFinance = new URL(QUOTE_URL);
            	} else {
            		yahooFinance = new URL("http://finance.yahoo.com/d/quotes.csv?s=" + strCustomStocks + "&f=" + URL_TAGS);
            	}
    ...
    public void prcLoadStocks() {
    	
    }
/*    
    public void YahooFinanceDataHelper() {
