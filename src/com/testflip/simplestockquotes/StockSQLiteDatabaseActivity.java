...
import com.testflip.simplestockquotes.R;
...
import com.testflip.simplestockquotes.MyApplication;

public class StockSQLiteDatabaseActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        stockList = YahooFinanceDataHelper.parseResponse(mApplication.strStocks);
        db.deleteAllStocks();      
    ...
    public void onClick(View v) 
    {
    	...
    	case R.id.btnSubmit:
    		...
    		{
    			Stock stock = searchStock(edtInput.getText().toString());
    			if (stock.getTicker() == "")
    			{
...
/*    		
    		...
    		*/
    		txtValue1.setText(String.valueOf(stockList.get(0).getClosingPrice()));
    		txtValue2.setText(String.valueOf(stockList.get(1).getClosingPrice()));
    		txtValue3.setText(String.valueOf(stockList.get(2).getClosingPrice()));
    		txtValue4.setText(String.valueOf(stockList.get(3).getClosingPrice()));
    		txtValue5.setText(String.valueOf(stockList.get(4).getClosingPrice()));    		
...
*/    	
    ...
    /*
     * Method to search Stock ArrayList by ticker symbol
     */
    ...
    /*
     * Method to search Stock ArrayList by name
     */
